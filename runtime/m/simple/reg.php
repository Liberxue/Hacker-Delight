...
<!--content-->
 ...
 <div class="page-title"><a href="javascript:history.back();void(0)" class="return">返 回</a>用户注册<a href="<?php echo urldecode(Url::urlFormat("/simple/login"));?>">登录<i></i></a></div>
	<form action="<?php echo urldecode(Url::urlFormat("/simple/reg_act"));?>" method="post" callback="checkReadme" style="padding-left:15px;"class="pxui-form-info">
		 ...
		 <div><span>验证码：</span><p><span><input type="text" class="input" name="verifyCode" id="verifyCode"  pattern="\w{4}" maxlength="4" ><img id="captcha_img"  src="<?php echo urldecode(Url::urlFormat("/simple/captcha/h/40/w/120"));?>"><label><a href="javascript:void(0)" class="red" onclick="document.getElementById('captcha_img').src='<?php echo urldecode(Url::urlFormat("/simple/captcha/h/40/w/120/random/"));?>'+Math.random()">换一张</span></p></div>
...
<div class="login-note mt20">
	<ul>
		<li><h4 class="pxui-color-blue">我已经注册， <a href="<?php echo urldecode(Url::urlFormat("/simple/login"));?>" class="red">登录</a></h1></li>
	</ul>
</div>
</div>
<script type="text/javascript">
